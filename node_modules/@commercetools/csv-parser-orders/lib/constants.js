...
const CONSTANTS = {
  ...
  requiredHeaders: {
    lineItemState: ['orderNumber', 'lineItemId', 'quantity', 'fromState', 'toState'],
    returnInfo: ['orderNumber', 'quantity', 'lineItemId', 'shipmentState', '_returnId'],
    deliveries: ['orderNumber', 'delivery.id', '_itemGroupId', 'item.id', 'item.quantity']
  },
  standardOption: {
